...
CREATE TABLE `ecm_coupon_sn` (
  ...
  KEY `coupon_id` USING BTREE (`coupon_id`) 
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `ecm_gcategory` (
  ...
  PRIMARY KEY (`cate_id`),
  KEY `store_id` USING BTREE (`store_id`,`parent_id`) 
...
CREATE TABLE `ecm_goods` (
  ...
  KEY `store_id` USING BTREE (`store_id`) ,
  KEY `cate_id` USING BTREE (`cate_id`) ,
  KEY `cate_id_1` USING BTREE (`cate_id_1`) ,
  KEY `cate_id_2` USING BTREE (`cate_id_2`) ,
  KEY `cate_id_3` USING BTREE (`cate_id_3`) ,
  KEY `cate_id_4` USING BTREE (`cate_id_4`) ,
...
CREATE TABLE `ecm_goods_qa` (
  ...
  PRIMARY KEY (`ques_id`),
  KEY `user_id` USING BTREE (`user_id`) ,
  KEY `goods_id` USING BTREE (`item_id`) ,
  KEY `store_id` USING BTREE (`store_id`) 
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ecm_member` (
  ...
  KEY `outer_id` USING BTREE (`outer_id`) 
...
CREATE TABLE `ecm_message` (
  ...
  PRIMARY KEY (`msg_id`),
  KEY `from_id` USING BTREE (`from_id`) ,
  KEY `to_id` USING BTREE (`to_id`) ,
...
CREATE TABLE `ecm_order` (
  ...
  KEY `order_sn` USING BTREE (`order_sn`,`seller_id`) ,
  KEY `seller_name` USING BTREE (`seller_name`) ,
  KEY `buyer_name` USING BTREE (`buyer_name`) ,
  KEY `add_time` USING BTREE (`add_time`) 
...
CREATE TABLE `ecm_order_extm` (
  ...
  PRIMARY KEY (`order_id`),
  KEY `consignee` USING BTREE (`consignee`) 
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `ecm_order_goods` (
  ...
  PRIMARY KEY (`rec_id`),
  KEY `order_id` USING BTREE (`order_id`,`goods_id`) 
...
CREATE TABLE `ecm_pageview` (
  ...
  PRIMARY KEY (`rec_id`),
  UNIQUE KEY `storedate` USING BTREE (`store_id`,`view_date`) 
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `ecm_payment` (
  ...
  KEY `store_id` USING BTREE (`store_id`) ,
  KEY `payment_code` USING BTREE (`payment_code`) 
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ecm_store` (
  ...
  KEY `store_name` USING BTREE (`store_name`) ,
  KEY `owner_name` USING BTREE (`owner_name`) ,
