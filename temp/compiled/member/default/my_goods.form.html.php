...
<div class="content">
    ...
    <div id="right">
        ...
        <div  class="wrap">
            <style>
    .dialog_body {width:845px;}
    .dialog_wrapper {width:800px;}
</style>

            <div class="public" style="height: auto;">
                <form method="post" id="goods_form">
                    <div class="information_index">
                        ...
                        <div class="add_spec" dialog_title="编辑商品规格" ectype="dialog_contents" style="display: none" >
                            ...
                            <div class="table" ectype="spec_editor" style="width:840px;">
                                <ul class="th" style="width:840px;">
                                    <li>
                                ...
                                <ul class="td" ectype="spec_item" style="width:840px;">
                                    <li>
                                ...
                                <ul>
                                    <li class="add">
                                        <a href="javascript:;" ectype="add_spec_item" class="add_link">添加新的规格属性</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="btn_wrap">
                                <input ectype="save_spec" type="submit" class="btn" value="保存规格" />
                            </div>
                            <!--</form>--></div>
...
?>
                        ...
                        <div class="add_wrap">
                            ...
                            <div class="pic_list">
                                <div class="big_pic">
                                    <img id="big_goods_image" src="<?php echo $this->_var['goods']['default_goods_image']; ?>" width="300" height="300" alt="" />
                                </div>
                                <div class="small_pic">
                                    <ul id="goods_images">
...
?>
                                ...
                                <div class="upload_btn">
                                    <div class="upload" id="open_uploader"> <b class="hide">上传商品图片</b>
                                    </div>
                            ...
                            <div class="products">
                                <ul>
                                    <li>
                                        <h2>商品名称:</h2>
                                        <div class="arrange">
                                            <input title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" type="text" name="goods_name" value="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" class="text width_normal" />
                                            <span class="red">*</span>
                                        </div>
                                    </li>
                                    <li>
                                        <h2>品牌:</h2>
                                        <div class="arrange">
                                            <input type="text" name="brand" value="<?php echo htmlspecialchars($this->_var['goods']['brand']); ?>" class="text width_normal" />
                                        </div>
                                    </li>
                                    <li>
                                        <h2>标签(TAG):</h2>
                                        <div class="arrange">
                                            <input type="text" name="tags" value="<?php echo htmlspecialchars($this->_var['goods']['tags']); ?>" class="text width_normal" />
                                            <span class="gray">多个标签请用逗号","格开</span>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="arrange">
                                            <div class="box_arr" ectype="no_spec"  style="display: none;">
                                                <p class="pos_btn">
                                                    <a ectype="add_spec" href="javascript:;" class="add_btn">开启规格</a>
                                                </p>
                                    ...
                                    <li>
                                        ...
                                        <div class="arrange">
                                            <span class="distance">
                                                <label>
                                                    <input name="if_show" value="1" type="radio" <?php if ($this->_var['goods']['if_show']): ?>checked="checked" <?php endif; ?>/>
                                                    是
                                                </label>
                                                <label>
                                                    <input name="if_show" value="0" type="radio" <?php if (! $this->_var['goods']['if_show']): ?>checked="checked" <?php endif; ?>/>
                                                    否
                                                </label>
                                            </span>
                                        </div>
                                    ...
                                    <li>
                                        ...
                                        <div class="arrange">
                                            <span class="distance">
                                                <label>
                                                    <input name="recommended" value="1" <?php if ($this->_var['goods']['recommended']): ?>checked="checked" <?php endif; ?>type="radio" />
                                                    是
                                                </label>
                                                <label>
                                                    <input name="recommended" value="0" <?php if (! $this->_var['goods']['recommended']): ?>checked="checked" <?php endif; ?>type="radio" />
                                                    否
                                                </label>
                                            </span>
                        ...
                        <div class="add_bewrite">
                            ...
                            <div class="add_wrap">
                                <div class="editor">
                                    <div><textarea name="description" id="description"  style="width:100%; height:400px;"><?php echo htmlspecialchars($this->_var['goods']['description']); ?></textarea></div>
                                    <div style=" position: relative; top: 10px; z-index: 5;">
                                        <a class="btn3" id="open_editor_uploader">上传图片</a>
                                    ...
                                    <ul id="desc_images" class="preview" style="">
