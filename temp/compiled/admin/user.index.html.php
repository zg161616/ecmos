...
?>
        <tr class="tatr2">
            <td class="firstCell">
                <input type="checkbox" class="checkitem" value="<?php echo $this->_var['user']['user_id']; ?>" />
            </td>
            ...
            <td><?php echo $this->_var['user']['parent_name']; ?></td>
      ...
      <td><?php echo $this->_var['user']['logins']; ?></td> -->
            <td>
                <?php if ($this->_var['user']['if_admin']): ?>是
                <?php else: ?><a href="index.php?app=admin&amp;act=add&amp;id=<?php echo $this->_var['user']['user_id']; ?>" onclick="parent.openItem('admin_manage', 'user');">设为管理员</a>
                <?php endif; ?>
            </td>
            <td class="handler">
