...
?>
  ...
  <div class="top-bg" style="/*position: fixed;z-index: 10000;width: 100%;*/">
      <div class="top fontsimsun clearfix">
          <div class="login_info">您好,<a href="<?php echo url('app=member'); ?>"><?php echo htmlspecialchars($this->_var['visitor']['user_name']); ?></a>
            ...
            <ul class="quick-menu">
              ...
              <li class="service"><a href="<?php echo url('app=article&code=' . $this->_var['acc_help']. ''); ?>" title="帮助中心">帮助中心</a></li>
