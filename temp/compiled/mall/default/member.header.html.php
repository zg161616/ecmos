  ...
  <div class="w1200 clearfix">
      ...
      <form method="GET" action="<?php echo url('app=search'); ?>">
        ...
        <div class="search-type clearfix">
            ...
            <input type="text" class="soso-input fl" value="请输入关键词" onfocus="if(this.value=='请输入关键词'){this.value='';}"  onblur="if(this.value==''){this.value='请输入关键词';}" name="keyword" style="height:31px;">
