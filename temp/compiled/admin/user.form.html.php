...
<div class="info">
  <form method="post" enctype="multipart/form-data" id="user_form">
    <table class="infoTable">
      ...
      <tr>
        <th class="paddingT15"> 直接上级:</th>
        <td class="paddingT15 wordSpacing5">
            <input class="infoTableInput2" name="parent_name" type="text" value="<?php echo $this->_var['user']['parent_name']; ?>" <?php if ($this->_var['user']['parent_name']): ?> readonly="readonly" <?php endif; ?> />
        </td>
      </tr>
      <tr>
