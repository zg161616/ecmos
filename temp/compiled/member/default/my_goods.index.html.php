            ...
            <div class="public_select table">
                <table id="my_goods" server="<?php echo $this->_var['site_url']; ?>/index.php?app=my_goods&amp;act=ajax_col" >
                    ...
                    <tr class="gray"  ectype="table_header">
                        <th width="80">商品雷达</th>
                        <th width="50" coltype="editable" column="add_time" checker="check_number" inputwidth="50px" title="排序"  class="cursor_pointer"><span ectype="order_by">上传时间</span></th>
...
?>
                    ...
                    <tr class="line line-blue<?php if (($this->_foreach['_goods_f']['iteration'] == $this->_foreach['_goods_f']['total'])): ?> last_line<?php endif; ?>" ectype="table_item" idvalue="<?php echo $this->_var['goods']['goods_id']; ?>">
                        ...
                        <td width="100"  align="center"><?php echo local_date("Y-m-d H:i:s",$this->_var['goods']['add_time']); ?></td>
                    ...
                    <tr class="line line-blue" style="border-right:1px #D4E7FF solid;"><td colspan="12">
                        <?php if ($this->_var['goods']['closed']): ?><font color="red">closed_reason:</font><?php echo $this->_var['goods']['close_reason']; ?><?php endif; ?>
                    </td></tr>
                    <?php endforeach; else: ?>
                    <tr>
