<div class="mpage">
    <a class="stat" style="padding: 0 20px;text-align: center;"><?php echo sprintf('共 %s 项', $this->_var['page_info']['item_count']); ?></a>
...
?>
    ...
    <a class="page_link" style="width:45px ;"href="<?php echo $this->_var['page_info']['last_link']; ?>"><?php echo $this->_var['page_info']['last_suspen']; ?>&nbsp;<?php echo $this->_var['page_info']['page_count']; ?></a>
    <?php endif; ?>
