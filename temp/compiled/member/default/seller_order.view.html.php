...
<script language="javascript">
       ...
       var dataObj=<?php echo $this->_var['shipping_info']; ?>;;//转换为json对象
...
?>
                ...
                <div class="transportation">配送费用&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order_extm']['shipping_fee']); ?><strong>(<?php echo htmlspecialchars($this->_var['options_shipping'][$this->_var['order_extm']['shipping_name']]); ?>)</strong></span>优惠打折&nbsp;:&nbsp;<span><?php echo price_format($this->_var['order']['discount']); ?></span>订单总价&nbsp;:&nbsp;<b><?php echo price_format($this->_var['order']['order_amount']); ?></b>
                &nbsp;&nbsp;&nbsp;
                <?php if ($this->_var['order']['trans_info']): ?>                
                    运费优惠&nbsp;:
                    <b><?php echo $this->_var['order']['trans_info']; ?></b>
                <?php endif; ?>
       ...
       <h3>收货人及物流信息</h3>
       <table id='shipping_detail'></table>
          <div class="goods">
           ...
           配送方式&nbsp;:&nbsp;<?php echo htmlspecialchars($this->_var['options_shipping'][$this->_var['order_extm']['shipping_name']]); ?><br/>
