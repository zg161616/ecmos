...
<div id="rightTop">
  ...
  <ul class="subnav">
    ...
    <li>
      <a class="btn1" href="index.php?app=my_goods&act=index">库存</a>
    </li>
  </ul>
</div>
...
?>
    ...
    <?php endif; ?>
      ...
      <td> <a target="" href="javascript:goods_toggle(<?php echo $this->_var['goods']['goods_id']; ?>);">详细</a>

      <a target="_blank" href="<?php echo $this->_var['site_url']; ?>/index.php?app=goods&amp;id=<?php echo $this->_var['goods']['goods_id']; ?>">查看</a></td>
    </tr>
    <tr class="tatr1 tar3">
      <td colspan="9">
        <div  class="show_spec spec_<?php echo $this->_var['goods']['goods_id']; ?>" style="display:none;">
          <?php if ($this->_var['goods']['_specs']): ?>
           <ul>
            <li><?php echo $this->_var['goods']['spec_name_1']; ?></li>
            <li><?php echo $this->_var['goods']['spec_name_2']; ?></li>
            <li>价格</li>
            <li>库存</li>
...
?>
          <ul>
            <li><?php echo $this->_var['spec']['spec_1']; ?></li>
            <li><?php echo $this->_var['spec']['spec_2']; ?></li>
            <li><?php echo $this->_var['spec']['price']; ?></li>
            <li><?php echo $this->_var['spec']['stock']; ?></li>
            <li><?php echo $this->_var['spec']['market_price']; ?></li>
          </ul>
           <div class="clear"></div>
