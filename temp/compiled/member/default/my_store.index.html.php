        ...
        <div class="public">
            ...
            <form method="post" enctype="multipart/form-data" id="my_store_form">
                    ...
                    <div class="setup info shop">
                        ...
                        <div class="photo relative2">
                                <?php $_from = $this->_var['advert_image']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filed');if (count($_from)):
    foreach ($_from AS $this->_var['filed']):
?>
                            <p style="height: 100px;">
                            <img src="<?php if ($this->_var['filed']['file_path'] != ''): ?><?php echo $this->_var['filed']['file_path']; ?><?php else: ?><?php echo $this->res_base . "/" . 'styles/default/images/member/banner.jpg'; ?><?php endif; ?>" width="132" height="46" ectype="store_banner" />
                            <span style="float: right;width: 300px;height: 60px;">
                            标&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;题：
                            <input name="title_<?php echo $this->_var['filed']['item_id']; ?>" type="text" class="text width_normal" id="im_ww" value="<?php echo htmlspecialchars($this->_var['filed']['file_title']); ?>" />
                            <br/><br/>
                            链接地址：
                            <input name="url_<?php echo $this->_var['filed']['item_id']; ?>" type="text" class="text width_normal" id="im_ww" value="<?php echo htmlspecialchars($this->_var['filed']['url']); ?>" />
                            </span>
                            <input type="file" name="image_<?php echo $this->_var['filed']['item_id']; ?>" />

                            </p>
                                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                            <span class="explain">change_store_advert_des</span>
                        </div>
                                 </td>
                             </tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <div class="editor">
                                        <div><textarea name="description" id="description" style="width:100%; height:350px;"><?php echo htmlspecialchars($this->_var['store']['description']); ?></textarea></div>
