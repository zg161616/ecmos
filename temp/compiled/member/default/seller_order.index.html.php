        ...
        <div class="wrap">
         	<div class="public_index table">
                <table>
                	...
                	<tr class="sep-row" height="20"><td colspan="10"></td></tr>
                    <tr class="line gray">
                        <th>商品名称</th>
                        <th>价格</th>
                        <th>数量</th>
...
?>
                    <tr class="line<?php if (($this->_foreach['fe_goods']['iteration'] == $this->_foreach['fe_goods']['total'])): ?> last_line<?php endif; ?>">
                        <td valign="top" class="first clearfix">
                            ...
                            <div class="txt-info fleft">
                            	<div class="txt">
                                	<a href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. ''); ?>" target="_blank"><?php echo sub_str($this->_var['goods']['goods_name'],60); ?></a>
                                </div>
                                <?php if ($this->_var['goods']['specification']): ?><p class="gray-color mt5"><?php echo $this->_var['goods']['specification']; ?></p><?php endif; ?>
                            </div>
                        </td>
                        
                        <td class="align2"><?php echo $this->_var['goods']['price']; ?></td>
                        <td class="align2"><strong><?php echo $this->_var['goods']['quantity']; ?></strong></td>
                        <?php if (($this->_foreach['fe_goods']['iteration'] <= 1)): ?>
                        <td class="align2 bottom-blue" rowspan="<?php echo $this->_var['order']['goods_quantities']; ?>">
                    ...
                    <?php endforeach; else: ?>
                    <tr><td class="member_no_records" colspan="10">没有符合条件的订单</td></tr>
